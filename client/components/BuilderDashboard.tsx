    ...
    <section className="container py-10">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl sm:text-3xl font-extrabold">
          Builder.io Dashboards
        </h1>
        <div className="text-sm text-muted-foreground">
          {sdkAvailable ? "Connected" : "Not connected"}
        </div>
      </div>
              ...
              <AreaChart data={utilizationData}>
                <defs>
                  <linearGradient id="bd_spent" x1="0" y1="0" x2="0" y2="1">
                    <stop
                      offset="5%"
                      stopColor="hsl(var(--sidebar-ring))"
                      stopOpacity={0.7}
                    />
                    <stop
                      offset="95%"
      ...
      <div className="mt-6 rounded-xl border p-4 bg-white/70 dark:bg-black/30">
        ...
        <div className="mt-3 text-sm text-muted-foreground">
          {sdkAvailable ? (
            <p>
              Builder SDK detected. Visual dashboards authored in Builder.io
              will render here when published and mounted.
            </p>
          ) : (
            <div>
              <p>
                No Builder.io integration detected. To enable visual dashboards:
              </p>
              <ol className="list-decimal pl-5 mt-2">
                <li>
                  Open the MCP popover and connect Builder.io to this project.
                </li>
                <li>
                  Install the @builder.io/react SDK and follow Builder.io docs
                  to mount content inside this route.
                </li>
                <li>
                  Use Builder.io editor to create dashboards and publish them.
                </li>
              </ol>
